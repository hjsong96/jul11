...
public class BoardController {
	...
	public String main() {//위 문장과 연결돼서 /main 이라는 요청이 오면
		return "main"; //jsp 파일명      //아래 jsp 파일을 열어줍니다.
	///WEB-INF/views/main.jsp 
	}
	/*
	 * Controller = 흐름제어 
	 *			  = 컨트롤 기능을 하는 인스턴스
	 *			  = 사용자의 요청이 들어오면 해당 URL 에 맞는
	 *				페이지와 데이터를 보내줍니다. 
	 * Service = 프로그램 로직
	 * 
	 * DTO/VO = 
	 ...
	 * 스프링 기술
	 * 
	 * POJO (Plain Old Java Object) 옛날 방식으로 만든 자바 코드
	 ...
	 * 		이러한 기술을 Ioc 컨테이너가 관리 서비스를 해줍니다. 
	 * 		IoC 컨테이너는 객체의 생성/초기화/서비스/소멸 -->
	 * 		               라이프사이클을 관리합니다.
	 * 
